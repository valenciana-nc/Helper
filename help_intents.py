...
_TOKEN_ALIASES = {
    ...
    "bag": {"basket", "cart"},
    "alert": {"alerts", "bell", "notification", "notifications", "notify"},
    "alerts": {"alert", "bell", "notification", "notifications"},
    "basket": {"bag", "cart"},
    "bell": {"alert", "alerts", "notification", "notifications", "notify"},
    "bookmark": {"favorite", "star"},
    "bold": {"b"},
    "bolded": {"b", "bold"},
    "bolden": {"b", "bold"},
    ...
    "notification": {"alert", "alerts", "bell", "notifications", "notify"},
    "notifications": {"alert", "alerts", "bell", "notification", "notify"},
    "notify": {"alert", "bell", "notification", "notifications"},
