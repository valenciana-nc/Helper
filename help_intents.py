...
_TOKEN_ALIASES = {
    ...
    "bag": {"basket", "cart"},
    "alert": {"alerts", "bell", "notification", "notifications", "notify", "warning"},
    "alerts": {"alert", "bell", "notification", "notifications", "warning"},
    "basket": {"bag", "cart"},
    "bell": {"alert", "alerts", "notification", "notifications", "notify", "warning"},
    "bookmark": {"favorite", "star"},
    "bold": {"b"},
    "bolded": {"b", "bold"},
    "bolden": {"b", "bold"},
    ...
    "notification": {"alert", "alerts", "bell", "notifications", "notify", "warning"},
    "notifications": {"alert", "alerts", "bell", "notification", "notify", "warning"},
    "notify": {"alert", "bell", "notification", "notifications", "warning"},
    ...
    "warning": {"alert", "alerts", "bell", "notification", "notifications"},
    "warnings": {"alert", "alerts", "bell", "notification", "notifications", "warning"},
...
def instruction_control_intents(instruction: str) -> set[str]:
    ...
    bookmark_action_requested = bool(raw_tokens & {"bookmark", "favorite", "star"})
    ...
    if tab_button_action_requested:
        intents.update(_BUTTON_INTENT_TYPES)
    if (
        not checkbox_requested
